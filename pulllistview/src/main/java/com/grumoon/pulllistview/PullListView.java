...
public class PullListView extends ListView {
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            case NONE:
                ...
                tvHeadTitle.setText(R.string.refresh);
                break;
            ...
            case RELEASE_TO_REFRESH:
                ...
                tvHeadTitle.setText(R.string.update_release);
            ...
            case REFRESHING:
                ...
                tvHeadTitle.setText(R.string.updating);
    ...
    private void refresh() {
        ...
        if (footView != null) {
            ...
            tvFootTitle.setText(R.string.load_more);
            isGetMoreing = false;
    ...
    private void getMore() {
        ...
        if (getMoreListener != null) {
            ...
            tvFootTitle.setText(R.string.loading);
